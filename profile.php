    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
            ...
            <div class="card-container">
              ...
              $artisan = $ConnectingDB->query("SELECT * FROM artisans JOIN users ON artisans.user_id = users.user_id WHERE artisan_id = 1");
              while ($a = $artisan->fetch(PDO::FETCH_ASSOC)) {
                echo '<p>'. $a['full_name']. '</p>';
                echo $a['company_name'];
                echo $a['email'];
                echo $a['phone_number'];
                echo $a['company_address'];
                echo $a['description'];
                echo $a['profile_picture'];
