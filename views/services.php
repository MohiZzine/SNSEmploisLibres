    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
            ...
            <div class="card-container">
              ...
              $artisan = $ConnectingDB->query("SELECT * FROM artisan_services NATURAL JOIN Artisan NATURAL JOIN user WHERE service_id= $service");
              while ($a = $artisan->fetch(PDO::FETCH_ASSOC)) {
                ?>
                <div class="card">
                  <form method="post" action="">
                    <!-- <input type="hidden" name="artisan_id" value="<?php echo $s["artisan_id"]; ?>"> -->
                    <button type="submit" id="artisan" name="artisan" class="btn">
                      <?php echo ?>
                    </button>
                  </form>
                </div>
